...
public class RxUtilsConfig {
    ...
    private RxUtilsConfig(Context context) {
        ...
        mAnUnknownErrorHint = mContext.getResources().getString(R.string.error_unknow);
    }

    String getAnUnknownErrorHint() {
    ...
    public static class ConfigBuilder {
        ...
        public ConfigBuilder setAnUnknownErrorHint(String anUnknownErrorHint) {
            mRxUtilsConfig.mAnUnknownErrorHint = anUnknownErrorHint;
            return this;
        }
